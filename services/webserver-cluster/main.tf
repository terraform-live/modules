...
resource "aws_autoscaling_group" "example" {
  ...
  name = "{var.cluster}-${aws_launch_configuration.example.name}"
  ...
  # Wait for at least this many instances to pass health checks before considering 
  # the ASG deployment complete
